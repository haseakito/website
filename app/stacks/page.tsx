...
export default function page() {
    ...
    const FrontData = [
        ...
        {
            title: 'Nuxtjs',
            src: 'https://develop365.gitlab.io/nuxtjs-2.8.X-doc/ja/logos/nuxt-icon-white.png',
  ...
  return (
    <div className='h-full z-auto'>        
        ...
        <div className='hidden xl:block rounded-xl mx-8 p-20 animate-fadeIn'>
            <h2 className='text-2xl font-bold font-mono rounded text-center'>Design</h2>
            <div className='flex flex-wrap gap-20 justify-center ml-10 p-10'>
            ...
            <h2 className='text-2xl font-bold font-mono text-center'>Front End</h2>
            <div className='flex gap-8 flex-wrap justify-between ml-10 p-10'>
            ...
            <h2 className='text-2xl font-bold font-mono text-center'>Back End</h2>
            <div className='flex flex-wrap justify-between ml-10 p-10'>
