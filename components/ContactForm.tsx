...
export function ContactForm() {
  ...
  return (
    <div className='relative group overflow-hidden'>
        ...
        >
            <h2
                className='flex justify-center sm:text-xl font-mono sm:font-semibold pb-4'
            >
               Let me know you! <span className='pl-1 animate-waving-hand'>🔎</span>
            </h2>
            ...
            <div className='flex justify-center mt-7'>
                <button
                    type='submit'
                    className='relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg bg-gradient-to-br from-cyan-500 to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800'
                >
                    <span className='relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md hover:bg-opacity-0'>
                        Submit
                    </span>
                </button>
            </div>
            <span className='absolute box-border z-10 -bottom-40 -right-36 bg-orange-400 w-60 h-96 rotate-45 transition-all translate-x-36 group-hover:translate-x-10'></span>
        </form>
    </div>
  )
}
